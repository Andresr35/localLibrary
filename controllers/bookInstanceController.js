...
exports.bookinstance_update_post = [
  body("status", "Must have a status").escape(),
  body("imprint", "Needs an imprint").trim().isLength({ min: 1 }).escape(),
  body("book", "Book required").escape(),
  body("due_back", "due sometime").escape(),
  asyncHandler(async (req, res, next) => {
    const errors = validationResult(req);
